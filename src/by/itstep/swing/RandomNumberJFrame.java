...
public class RandomNumberJFrame extends JFrame {
    private int x;
                ...
                if(attempts > 0){
                    ...
                    if(x == userX){
                        ...
                        if(attempts == 1){
                            ...
                            msg.setText("you number is " + (userX > x ? " greater " : "less "));
                        }
                    }
                }
...
class Player {
    public static void main(String[] args) {
        RandomNumberJFrame game = new RandomNumberJFrame();
    }
}